...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Редагувати відділення: {{$data->title}}</h2>
            <ol class="breadcrumb">
                <li>
                    {{ link_to_route('admin.index', 'Головна') }}
                </li>
                <li>
                    {{ link_to_route('departments.index', 'Відділення') }}
                </li>
                <li class="active">
                    <strong>Редагувати відділення</strong>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="wrapper wrapper-content animated fadeInRight ecommerce">
        {{ Form::model($data, ['route' => ['departments.update', $data->id], 'method' =>'PUT' ]) }}
        <div class="row">
            <div class="col-lg-6">
