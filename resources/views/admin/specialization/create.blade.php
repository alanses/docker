...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{ route('specializations.index') }}">Список спеціалізацій</a>
                </li>
                <li class="active">
                    <strong>Створити спеціалізацію</strong>
                </li>
            </ol>
        </div>
    </div>
    ...
    <div class="wrapper wrapper-content animated fadeInRight ecommerce">
        {{ Form::open(array('route' => 'specializations.store','files' => true, 'method' => 'post')) }}
        <div class="row">
            <div class="col-lg-6">
